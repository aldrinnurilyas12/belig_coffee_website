...
<head>
    ...
    <title>Tanggapi keluhan pelanggan</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Tanggapi Keluhan Pelanggan</h5>



                <!-- Multi Columns Form -->
                <form role="form" method="post" action="<?php echo base_url() . 'admin/replykeluhan/reply' ?>"
                    enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputName5" class="form-label">Id</label>
                        <input type="text" value="<?php echo $keluhan_id; ?>" name="keluhan_id" class="form-control"
                            id="inputName5" autocomplete="off" readonly>
                    </div>


                    <input type="text" value="<?php echo $plg_id; ?>" name="plg_id" class="form-control" hidden
                        id="price" autocomplete="off" readonly>

                    <div class="col-md-5">
                        <label for="inputEmail5" class="form-label">Nama Pelanggan</label>
                        <input type="text" value="<?php echo $plg_nama; ?>" name="plg_nama" class="form-control"
                            id="price" autocomplete="off" readonly>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" name="kategori" value="<?php echo $kategori; ?>" class="form-control"
                            placeholder="masukan diskon" id="mrp" autocomplete="off" readonly>
                    </div>
                    <div class="col-md-5">
                        <label for="inputPassword5" class="form-label">Keluhan</label>
                        <textarea readonly name="keluhan" class="form-control"
                            id="discount"><?php echo $keluhan; ?></textarea>
                    </div>
                    <div class="col-md-5">
                        <label for="inputPassword5" class="form-label">Beri Tanggapan</label>
                        <input step="height:60px;" type="text" name="tanggapan" class="form-control">
                    </div>
                    ...
                    <div class="col-md-3">
                        <label for="inputAddress5" class="form-label">Tanggal Keluhan</label>
                        <p><?php echo $tanggal_keluhan; ?></p>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <input step="height:60px;" hidden value="sudah ditanggapi" type="text" name="kel_status"
                            class="form-control">
                    </div>
