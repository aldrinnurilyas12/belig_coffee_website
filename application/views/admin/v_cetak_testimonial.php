                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($testimonial->result_array() as $a) {


                                        $nama = $a['plg_nama'];
                                        $rating = $a['rating'];
                                        $isi_testimonial = $a['isi_testimonial'];
                                        $balasan = $a['balasan'] !== null ? $a['balasan'] : null;
                                        $tgl = $a['tgl_testimonial'];
                ...
                success: function(response) {
                    ...
                    $.each(testimonialData, function(index, data) {
                        ...
                        var row = '<tr>' +
                            '<td>' + data.plg_nama + '</td>' +
                            '<td>' + data.rating + '</td>' +
                            '<td>' + data.isi_testimonial + '</td>' +
                            '<td>' + balasan + '</td>' +
                            '<td>' + data.tgl_testimonial + '</td>' +
                            '</tr>';
