                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $status == 'Menunggu Konfirmasi'  ? '<p style="width:90px;color:green;font-weight:bold; 
                                        font-size:17px;text-align:center;background-color:#B4FF9F;">Menunggu Konfirmasi</p>' :
                                                '<p style="width:90px;color:blue;font-weight:bold; font-size:17px;background-color:#DBDFFD;" >
                            Dikirim</p>'; ?> </td>
                                        <td class="text-right">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;"><?php echo number_format($menu_harjul); ?>
                                                    </td>
                                                    <td style="text-align:center;"><?php echo $menu_porsi; ?></td>
                                                    <td style="text-align:center;"><?php echo number_format($menu_subtotal); ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
...
========================================================================================================== -->
    ...
    <script src="<?php echo base_url() . 'assets/js/DataTables/extensions/TableTools/js/dataTables.tableTools.min.js' ?>">
    </script>
