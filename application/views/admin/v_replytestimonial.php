...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Balas Testimonial Pelanggan</h5>



                <!-- Multi Columns Form -->
                <form role="form" method="post" action="<?php echo base_url() . 'admin/replytestimonial/reply' ?>" enctype="multipart/form-data" class="row g-3">
                    <div class="col-md-2">
                        <label for="inputName5" class="form-label">Id</label>
                        <input type="text" value="<?php echo $id_testimonial; ?>" name="id_testimonial" class="form-control" id="inputName5" autocomplete="off" readonly>
                    </div>


                    <input type="text" value="<?php echo $plg_id; ?>" name="plg_id" class="form-control" hidden id="price" autocomplete="off" readonly>

                    <div class="col-md-5">
                        <label for="inputEmail5" class="form-label">Nama Pelanggan</label>
                        <input type="text" value="<?php echo $plg_nama; ?>" name="plg_nama" class="form-control" id="price" autocomplete="off" readonly>
                    </div>
                    <div class="col-md-3">
                        <label for="inputPassword5" class="form-label">Rating</label>
                        <input type="text" name="rating" value="<?php echo $rating; ?>" class="form-control" placeholder="masukan diskon" id="mrp" autocomplete="off" readonly>
                    </div>
                    <div class="col-md-5">
                        <label for="inputPassword5" class="form-label">Testimonial</label>
                        <textarea readonly name="isi_testimonial" class="form-control" id="discount"><?php echo $isi_testimonial; ?></textarea>
                    </div>
                    <div class="col-md-5">
                        <label for="inputPassword5" class="form-label">Balas</label>
                        <input step="height:60px;" type="text" name="balasan" class="form-control" id="TotalDiscount">
                    </div>
                    <div class="col-md-3">
                        <label for="inputAddress5" class="form-label">Tanggal Testimonial</label>
                        <p><?php echo $tgl_testimonial; ?></p>
                    </div>

                    <div class="col-md-3">
                        <label for="inputAddress5" class="form-label">Tanggal Pembayaran</label>
                        <p><?php echo $tgl_bayar; ?></p>
                    </div>
