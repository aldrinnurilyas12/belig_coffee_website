					...
					<div class="row">
						...
						<table class="table table-hover" id="datatable1">
							...
							<tbody>
								...
								?>
									<tr>
										<td><img style="width:80px;height:80px;" class="img-thumbnail width-1" src="<?php echo base_url() . 'assets/galeries/' . $gambar; ?>" alt="" />
										</td>
			...
			<div class="menubar-scroll-panel">
				...
				<div class="menubar-foot-panel">
					<small class="no-linebreak hidden-folded">
						<span class="opacity-75">&copy; <?php echo date('Y'); ?></span> <strong>Mahakarya
							Technology</strong>
					</small>
				</div>
			</div>
