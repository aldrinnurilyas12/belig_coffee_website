...
<body class="o-page" style="background-color:#fff;">
    ...
    <div style="display: flex;height:80px;" class="bannerPane banner-bg">
        ...
        <div style="display:flex;justify-content:space-between;height:40px;padding:35px;" class="s-banner-content">
            <h3 style="font-weight: bold;">Booking Meja Belig Coffee</h3>
    ...
    <div id="content">
        ...
        <article>
            ...
            <div class="prod-single-content">
                <h2 style="font-size: 15px;font-weight:bold;">Daftar Menu anda</h2>
                <table style="width:100%">
                    <thead>
                        ...
                        <tbody style="font-size: 16px;">
                            <form action="<?php echo base_url() . 'mobile/menu/updatepickup/' ?>" method="post">
                                <?php $i = 1; ?>
                                <?php foreach ($this->cart->contents() as $items) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><a style="padding: 8px;background:red;color:white;border-radius:5px;text-decoration:none;font-weight:bold;" href="<?php echo base_url() . 'mobile/menu/hapus/' . $items['rowid']; ?>">Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                ...
                margin-top:13.6cm;background:white;margin-left:28rem;color:#332cF2; cursor:pointer;">Update
                    Keranjang</button>
                </form>

                <div class="content">
                    <form action="<?php echo base_url() . 'mobile/menu/check_outreservasi' ?>" method="post">
                        <div style="display: block;" class="text-note">

                            <div class="noted">
                                <label style="color: black;font-size:15px;font-weight:bold;" for="">Jadwalkan kedatangan
                                    anda</label>
                                <p style="color: gray;">Jam Operasional Cafe 16:00PM - 23:30 PM</p>
                                <input name="tanggal_kedatangan" style="width: 300px;height:40px;" type="datetime-local">
                            </div>
                            ...
                            <div class="noted">
                                <label style="color: black;font-size:15px;font-weight:bold;" for="">Jumlah Tamu</label>
                                <input name="jumlah_tamu" style="width: 120px;height:50px;text-align:center;" type="number">
                            </div>
                            ...
                            <div class="noted">
                                <label style="color: black;font-size:15px;font-weight:bold;" for="">Kirim Note
                                    (Opsional):
                                </label>
                            ...
                            <div style="width: 450px;" class="noted">
                                <label style="color: black;font-size:15px;font-weight:bold;height:max-content;" for="">Pilih
                                    No. Meja :
                                </label>
                                ...
                                <div style="display: block;width:460px;" class="content-items">
                                    ...
                                    <div class="wrapper">
                                        <input value="Meja 1" type="radio" name="no_meja" id="option-1">
                                        <input value="Meja 2" type="radio" name="no_meja" id="option-2">
                                        <input value="Meja 3" type="radio" name="no_meja" id="option-3">
                                        <input value="Meja 4" type="radio" name="no_meja" id="option-4">
                                        <input value="Meja 5" type="radio" name="no_meja" id="option-5">
                                        <input value="Meja 6" type="radio" name="no_meja" id="option-6">
                                    ...
                                    <div class="wrapper">
                                        <input value="Meja 7" type="radio" name="no_meja" id="option-7">
                                        <input value="Meja 8" type="radio" name="no_meja" id="option-8">
                                        <input value="Meja 9" type="radio" name="no_meja" id="option-9">
                                        <input value="Meja 10" type="radio" name="no_meja" id="option-10">
                                        <input value="Meja 11" type="radio" name="no_meja" id="option-11">
                                        <input value="Meja 12" type="radio" name="no_meja" id="option-12">
                        ...
                        <button style="background-color: #332CF2;color:white;padding:15px;cursor:pointer;font-weight:bold;border:none;border-radius:4px;" type="submit">Pesan</a>
                    </form>
                </div>
