...
<body class="o-page" style="background-color:#fff;">
    ...
    <div style="display: flex;height:80px;" class="bannerPane banner-bg">
        ...
        <div style="display:flex;justify-content:space-between;height:40px;padding:35px;" class="s-banner-content">
            <h3 style="font-weight: bold;">Pemesanan Anda</h3>

            <a style="padding: 6px;background:green;color:#fff;width:70px;height:35px;font-weight:bold;font-size:14px;text-decoration:none;border-radius:5px;"
                href="<?php echo base_url() ?>mobile/beranda">Home</a>
            ...
            <div class="prod-single-content">
                <table style="border:none;padding:0px;font-size:3px;">
                    <tr style="background-color:#fff;">
                        <td>No Pemesanan </td>
                        <td>:</td>
                        <td style="font-weight: 700;"><?php echo $b['pemesanan_id'] ?></td>
                    </tr>
                    <tr style="background-color:#fff;">
                        <td>Tanggal</td>
                        <td>:</td>
                        <td style="font-weight: 700;"><?php echo $b['tanggal_pemesanan'] ?></td>
                    </tr>
                    <tr style="background-color:#fff;">
                        <td>Customer</td>
                        <td>:</td>
                    ...
                    <tr style="background-color:#fff;">
                        <td>Status Order</td>
                        <td>:</td>
                        <td style="font-weight: 700;"><?php echo $b['status'] ?></td>
                    </tr>
                    <tr style="background-color:#fff;">
                        <td>Notes</td>
                        <td>:</td>
                    ...
                    <tr style="background-color:#fff;">
                        <td>No Meja</td>
                        <td>:</td>
                        <td style="font-weight: 700;"> <?php echo $b['meja'] ?></td>
                    </tr>
                </table>
