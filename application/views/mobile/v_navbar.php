    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                &nbsp;
                <a href="<?php echo base_url() ?>mobile/testimonial">Testimonial</a></li>
                ...
                <div class="dropdown show">
                    <a style="font-weight: bold;background:#FFBF00;padding:5px;color:black;border-radius:5px;"
                        class=" dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a style="font-weight: 500;" class="dropdown-item"
                            href="<?php echo base_url() ?>mobile/pembayaran/paymentdinein">Pembayaran</a>
                        <a style="font-weight: 500;" class="dropdown-item"
                            href="<?php echo base_url() ?>mobile/history_order">Riwayat
                            Dine In</a>
                    </div>
                ...
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a style="font-weight: 500;" class="dropdown-item"
                            href="<?php echo base_url() ?>mobile/reservasi">Booking Meja</a>

                        <a style="font-weight: 500;" class="dropdown-item"
                            href="<?php echo base_url() ?>mobile/pembayaran/pembayaranreservasi">Pembayaran</a>
                        <a style="font-weight: 500;" class="dropdown-item"
                            href="<?php echo base_url() ?>mobile/member/historyreservasi">Riwayat
                            Booking</a>
                    </div>
