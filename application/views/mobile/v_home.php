...
<body>
            ...
            <div class="row justify-content-between gy-5">
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">Ada banyak varian menu yang bisa kamu pilih
                        di Belig Coffee! Barista kami siap memberikan rekomendasi menu signature untuk #temanbelig
                        Dan dapatkan promo menarik setiap harinya.</p>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" style="width:500px;height: 400px;" src="../assets/images/banner2.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" style="width:500px;height: 400px;" src="../assets/images/banner3.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" style="width:500px;height: 400px;" src="../assets/images/banner.jpg" alt="Third slide">
                            </div>
                        </div>
                ...
                <!-- <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
                    <img style="width:500px;height: 400px;" src="../assets/images/banner2.jpg" class="img-fluid" alt=""
    ...
    <main id="main">
                            ...
                            ?>
                                <div style="margin-left: 6px;height:max-content;" class="card">
                                    <article style="height: max-content;">
                                        ...
                                        <a data-target="#exampleModalCenter<?php echo base_url()  . $a['id_menu']; ?>" data-toggle="modal" href="#">
                                            <div class="card-image">
                                                <p style="font-size:13px;padding: 2px;background:red;color:white;position:absolute;border-radius:4px;margin-top:5px;margin-left:5px;">
                                                    <?php echo $promo; ?></p><img style="padding: 0px;height:155px;width:175px;" class="p-8 rounded-t-lg" src="<?php echo base_url() . 'assets/gambar/' . $gambar; ?>" alt="product image" />
                                            ...
                                            <div style="display: flex;height:20px;" class="d-flex-diskon">
                                                ...
                                                <div class="category">
                                                    <p style="font-size: 14px;color:gray;text-decoration:line-through;font-weight:400;">
                                        ...
                                        <a style="width: 65px;height:30px;padding:5px;" href="<?php echo base_url() . 'mobile/menu/add_to_cart/' . $a['id_menu']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                            ...
                            ?>
                                <div style="margin-left: 6px;height:max-content;" class="card">
                                    <article style="height: max-content;">
                                        ...
                                        <a data-target="#exampleModalCenter<?php echo base_url()  . $a['menu_id']; ?>" data-toggle="modal" href="#">
                                            <div class="card-image">
                                                <img style="padding: 0px;height:155px;width:175px;" class="p-8 rounded-t-lg" src="<?php echo base_url() . 'assets/gambar/' . $gambar; ?>" alt="product image" />
                                            ...
                                            <div style="display: flex;justify-content:space-between;margin-top:-12px;" class="dflex">

                                                <div style="color: black;font-weight:500;" class="heading">Rp
                                                    &nbsp;<?php echo number_format($harga_menu) ?></div>
                                        </a>
                                        <a style="width: 65px;height:30px;padding:5px;" href="<?php echo base_url() . 'mobile/menu/add_before_to_cart/' . $a['menu_id']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                            focus:outline-none  font-medium rounded-lg text-sm 
                             py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 
                            dark:focus:ring-blue-800">Add</a>
        ...
        foreach ($data->result_array() as $a) {
            ...
            $plg_nama = $a['plg_nama'];
            $rating = $a['rating'];
            $isi_review = $a['isi_review'];
            $tgl_review   = $a['tanggal_review'];

        ?>
            <div class="modal fade" id="exampleModalCenter<?php echo base_url()  . $a['id_menu']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div style="width: 400px;" class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="image">
                                <p style="font-weight:700;font-size:15px;padding: 5px;background:red;color:white;position:absolute;border-radius:4px;margin-top:5px;margin-left:5px;">
                                    <?php echo $a['diskon']; ?>&nbsp;% &nbsp;Off</p>
                                <img style="border-radius: 5px;height:250px;width:366px;" src="<?php echo base_url() . 'assets/gambar/' . $a['menu_gambar'] ?>" />
                            </div>
                            <h5 style="color: black;font-weight:700;margin-bottom:8px;margin-top:8px;">
                                <?php echo $a['menu_nama'] ?></h5>

                            <p style="padding:4px;font-size:13px; color:#00AA13;width:max-content;border-radius:4px;font-weight:500;">
                            ...
                            <div class="review-customer">
                                ...
                                <div style="height:80px;overflow-y:scroll;" class="scroll">
                                    ...
                                    <div style="height: max-content ; background:#EDE4ff;color:black;padding:5px;margin-top:5px;" class="box-container">
                                        ...
                                        <div style="display: block;" class="content">
                                            ...
                                            <div style="display: flex;height:25px;" class="rate">
                                                <p><img style="width: 20px;height:20px;margin:0;" src="<?php echo base_url() . 'assets/images/rating.png' ?>" alt="">
                                                </p>
                                                <p> <?php echo $rating; ?></p>
                                            ...
                                            <p style="margin: 0;"><?php echo $isi_review; ?></p>
                                        </div>
                                    </div>
                        ...
                        <div style="display: flex;justify-content:space-between;" class="modal-footer">
                            ...
                            <div style="display: flex;" class="btn-cl">
                                <a style="width: 105px;height:30px;padding:5px;margin-right:8px;background:#EDE4ff;color:#4942E4;" href="<?php echo base_url() . 'mobile/review/givereview/' . $a['id_menu']; ?>" class=" bg-yellow-700 hover:bg-blue-800 focus:ring-4 
                                            focus:outline-none  font-medium rounded-lg text-sm 
                                            py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 
                                            dark:focus:ring-blue-800">Beri Ulasan</a>
                                <a style="width: 90px;height:30px;padding:5px;" href="<?php echo base_url() . 'mobile/menu/add_to_cart/' . $a['id_menu']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                                        focus:outline-none  font-medium rounded-lg text-sm 
                                        py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 
        ...
        ?>
            <div class="modal fade" id="exampleModalCenter<?php echo base_url()  . $a['menu_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div style="width: 400px;" class="modal-content">
                        <div class="modal-header">
                            <h5 style="font-weight: 600;font-size:14px;" class="modal-title" id="exampleModalLongTitle">
                        ...
                        <div style="display: flex;justify-content:space-between;" class="modal-footer">
                            ...
                            <a style="width: 135px;height:40px;padding:10px;" href="<?php echo base_url() . 'mobile/menu/add_before_to_cart/' . $a['menu_id']; ?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 
                        focus:outline-none  font-medium rounded-lg text-sm 
                         py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 
